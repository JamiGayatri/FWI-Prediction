...
# ------------------------------------------------------
# 2. FEATURE SELECTION BY CORRELATION (MODULE 3)
# ------------------------------------------------------
...
# ------------------------------------------------------
# 4. SCALING WITH STANDARDSCALER + SAVE (MODULE 3)
# ------------------------------------------------------
...
# ------------------------------------------------------
# 5. RIDGE REGRESSION + ALPHA TUNING (MODULE 4)
# ------------------------------------------------------
...
for alpha in alphas:
    ...
    # Under/overfitting label (Module 5 – optimization)
    ratio = mse_tr / mse_te
    if ratio < 0.7:
        status = "OVERFITTING"
    elif ratio > 1.3:
...
# ------------------------------------------------------
# 6. CHOOSE BEST ALPHA (MODULE 4 & 5)
# ------------------------------------------------------
...
# ------------------------------------------------------
# 7. TRAIN FINAL MODEL & SAVE (MODULE 4)
# ------------------------------------------------------
...
# ------------------------------------------------------
# 8. LOG ALL METRICS (DOCUMENT TRAINING) (MODULE 4)
# ------------------------------------------------------
